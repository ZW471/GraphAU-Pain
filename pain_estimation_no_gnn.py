...
from model.ANFL import MEFARG, PainEstimation, BackboneOnly, FullPictureMEFARG, FullPictureMEFARGNoGNN
from dataset import *
from utils import *
...
def main(conf):
    ...
    net = FullPictureMEFARGNoGNN(num_classes=conf.num_classes, backbone=conf.arc, neighbor_num=conf.neighbor_num, metric=conf.metric)
    # resume
    if conf.resume != '':
